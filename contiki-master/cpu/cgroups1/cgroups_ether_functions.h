 ...
 * Author: jhebus
 *
 * Created on 20 November 2008, 16:44
 */

#ifndef _CGROUPS_ETHER_FUNCTIONS_H
#define	_CGROUPS_ETHER_FUNCTIONS_H
...
/*Calculates the crc for a byte of data*/
uint16_t crcByte(uint16_t crc, uint8_t b);

/*Uses the above to calculate the crc for an arbitrary data length*/
